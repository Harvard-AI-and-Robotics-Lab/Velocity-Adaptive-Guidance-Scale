...
GEN_IMAGE_DIR=(
            outputs/cub_200_sd35/vagsgen_k0p5_caption_results.json 
            outputs/cub_200_sd35/vagsgen_k0p7_caption_results.json 
            outputs/cub_200_sd35/vagsgen_k0p9_caption_results.json
                )
...
do
    ...
    python evaluate_CLAIR_with_generated_captions_parallel.py \
