...
# Data
labels = [r'$\xi_\ast$=-0.25', r'$\xi_\ast$=0', r'$\xi_\ast$=0.25']
fids = [75.62, 75.23, 75.62]
clipscores = [0.3386, 0.3378, 0.3386]
...
# ax1.set_xlabel(r'Target parameter ($\xi_\ast$)', fontsize=8, fontweight='bold')
...
# Save figure
# plt.savefig('/mnt/user-data/outputs/xi_ast_barchart.png', 
#             dpi=300, 
#             bbox_inches='tight',
#             facecolor='white')
plt.savefig('data4paper/ablation_barchart_xi.pdf', 
            bbox_inches='tight',
            facecolor='white')

print("Bar chart saved successfully!")
print("- PNG: xi_ast_barchart.png")
print("- PDF: xi_ast_barchart.pdf")
