...
# Data
labels = [r'$\gamma$=0.9', r'$\gamma$=0.95', r'$\gamma$=0.99']
fids = [75.88, 77.14, 78.36]
clipscores = [0.3388, 0.3381, 0.3380]
...
# ax1.set_xlabel(r'Discount factor ($\gamma$)', fontsize=8, fontweight='bold')
...
# Save figure
# plt.savefig('/mnt/user-data/outputs/nature_style_barchart.png', 
#             dpi=300, 
#             bbox_inches='tight',
#             facecolor='white')
plt.savefig('data4paper/ablation_barchart_gamma.pdf', 
            bbox_inches='tight',
            facecolor='white')

print("Bar chart saved successfully!")
print("- PNG: nature_style_barchart.png")
print("- PDF: nature_style_barchart.pdf")
