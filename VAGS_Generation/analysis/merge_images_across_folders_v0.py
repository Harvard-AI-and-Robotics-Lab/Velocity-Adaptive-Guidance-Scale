...
def merge_images(input_folder, subfolders, output_dir, direction='horizontal', spacing=0):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('--spacing', type=int, default=0,
                        help='Pixels of spacing between images (default: 0)')
    
    args = parser.parse_args()
    print(args.input_folder)
    print(args.subfolders,)
    merge_images(
